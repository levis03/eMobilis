...
error_reporting(0); // Suppress error reporting for this page
...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        $id = $_GET['del']; // Get the ID of the leave type to delete
        $sql = "DELETE FROM tblleavetype WHERE id=:id"; // SQL query to delete the record
        $query = $dbh->prepare($sql);
        $query->bindParam(':id', $id, PDO::PARAM_STR);
        $query->execute();
        $msg = "Leave type record deleted"; // Success message
    }
?>
            ...
            <div class="sidebar-menu">
                ...
                <div class="main-menu">
                    <div class="menu-inner">
                        <?php
                        $page = 'leave'; // Set active page for sidebar highlight
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="data-tables datatable-dark">
                                        ...
                                        <table id="dataTable3" class="table table-hover table-striped text-center">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql = "SELECT * FROM tblleavetype"; // SQL query to fetch leave types
                                                $query = $dbh->prepare($sql);
                                                $query->execute();
                                                    ...
                                                    foreach ($results as $result) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="edit-leaveType.php?lid=<?php echo htmlentities($result->id); ?>"><i class="fa fa-edit" style="color:green"></i></a>
