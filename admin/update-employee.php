...
error_reporting(0); // Disable error reporting (change as needed for debugging)
...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $msg = "Employee record updated Successfully"; // Success message
    }
?>
            ...
            <div class="sidebar-menu">
                ...
                <div class="main-menu">
                    <div class="menu-inner">
                        <?php
                        $page = 'employee';
                        include '../includes/admin-sidebar.php'; // Include sidebar menu
                        ?>
                    </div>
                </div>
            </div>
...
<?php } // End of else block for logged-in users 
?>