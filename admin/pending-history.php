            ...
            <div class="sidebar-menu">
                ...
                <div class="main-menu">
                    <div class="menu-inner">
                        <?php
                        $page = 'manage-leave'; // Set the current page identifier
                                    ...
                                    <div class="single-table">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped table-bordered progress-table text-center">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $status = 0; // Status for pending leaves
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid); ?>" class="btn btn-secondary btn-sm">View Details</a>
                                                                </td>
                                                            </tr>
                                                    <?php $cnt++;
                                                        }
